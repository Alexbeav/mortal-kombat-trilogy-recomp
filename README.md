# Mortal Kombat Trilogy Recompiled

This release candidate uses PSXRecomp and the shared recomp-ui launcher.
You must supply your own SLUS-00330 game disc and SCPH-5502/5552 Europe BIOS.
...
2. Start `Mortal_Kombat_Trilogy_Recompiled` (`.exe` on Windows).
